...
public class Console extends JFrame implements ActionListener{
    ...
    */
   public Shape fillRect(int x, int y, int width, int height)  {
      Rectangle2D.Double rect = new Rectangle2D.Double(x,y,width,height);
      canvas.fill(rect);
      return rect;
   }
   public Shape fillRect(int x, int y, int width, int height, int degrees)  {
      Rectangle2D.Double rect = new Rectangle2D.Double(x,y,width,height);
      Shape sh = canvas.drawRotatedShape(rect, degrees, x + width / 2, y + height / 2, true);
      return sh;
   }
    ...
    * @param height Height in pixels
    */
   public Shape drawRect(int x, int y, int width, int height) {
      Rectangle2D.Double rect = new Rectangle2D.Double(x,y,width,height);
   ...
   public Shape drawRect(int x, int y, int width, int height, int degrees) {
      Rectangle2D.Double rect = new Rectangle2D.Double(x,y,width,height);
      Shape sh = canvas.drawRotatedShape(rect, degrees, x + width / 2, y + height / 2, false);
      return sh;
   }
    ...
    * @param height Height in pixels
    */
   public Shape fillOval(int x, int y, int width, int height) {
      Ellipse2D.Double oval = new Ellipse2D.Double(x,y,width,height);
      canvas.fill(oval);    
      return oval;  
   }
   public Shape fillOval(int x, int y, int width, int height, int degrees) {
      Ellipse2D.Double oval = new Ellipse2D.Double(x,y,width,height);
      Shape sh = canvas.drawRotatedShape(oval, degrees, x + width / 2, y + height / 2, true);
      return sh;
   }
    ...
    * @param height Height in pixels
    */
   public Shape drawOval(int x, int y, int width, int height) {
      Ellipse2D.Double oval = new Ellipse2D.Double(x,y,width,height);
      canvas.draw(oval);
      return oval;
   }
   
   public Shape drawOval(int x, int y, int width, int height, int degrees) {
      Ellipse2D.Double oval = new Ellipse2D.Double(x,y,width,height);
      canvas.drawRotatedShape(oval, degrees, x + width / 2, y + height / 2, false);
      return oval;
   }   
    ...
    */
   public Shape drawPolygon(int[] x, int[] y, int n) {
    ...
    * @param n Number of points in the polygon
    */
   public Shape fillPolygon(int[] x, int[] y, int n) {
    ...
    */
   public Shape drawArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
      Arc2D.Double arc = new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.OPEN);
      canvas.draw(arc);
      return arc;
   }
   public Shape drawArc(int x, int y, int width, int height, int startAngle, int arcAngle, int degrees) {
      Arc2D.Double arc = new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.OPEN);
         
      int xc = x + width/2;
      int yc = y + height/2;
      Shape sh = canvas.drawRotatedShape(arc, degrees,xc,yc,false);
      return sh;
   }
    ...
    * @param arcAngle Number of degrees of arc to draw
    */
   public Shape fillArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
      Arc2D.Double arc = new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.PIE);   
      canvas.fill(arc);
      return arc;
   }
   public Shape fillArc(int x, int y, int width, int height, int startAngle, int arcAngle, int degrees) {
      Arc2D.Double arc = new Arc2D.Double(x, y, width, height, startAngle, arcAngle, Arc2D.PIE);   
      
      int xc = x + width/2;
      int yc = y + height/2;
      Shape sh = canvas.drawRotatedShape(arc, degrees,xc,yc,true);
      return sh;
   }
   ...
   public void drawString(String str, int x, int y, int degrees) {
      canvas.drawString(str, x, y, degrees);
   }
   ...
   public void drawImage( Image img, int x, int y) {
      canvas.drawImage((BufferedImage)img, x, y);
   }
   public void drawImage(Image img, int x, int y, int degrees) {
      canvas.drawImage((BufferedImage)img, x, y, degrees);
   }
   ...
   public void drawImage(Image img, int x, int y, int width, int height) {
      canvas.drawImage((BufferedImage)img, x, y, width, height);
   }
   public void drawImage(Image img, int x, int y, int width, int height, int degrees) {
   
      canvas.drawImage((BufferedImage)img, x, y, width, height, degrees);
   }
    ...
    */
   public Shape drawStar (int x, int y, int width, int height) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
    ...
    *            The height of the rectangle that the star is inscribed in.
    */
   public Shape drawStar (int x, int y, int width, int height, int degrees) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
      ...
      Shape sh = canvas.drawRotatedShape(p, degrees,xc,yc,false);
      return sh;
   } 
    ...
    *            The height of the rectangle that the star is inscribed in.
    */
   public Shape fillStar (int x, int y, int width, int height) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
    ...
    *            The height of the rectangle that the star is inscribed in.
    */
   public Shape fillStar (int x, int y, int width, int height, int degrees) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
      ...
      Shape sh = canvas.drawRotatedShape(p, degrees,xc,yc,true);
      return sh;
   }
    ...
    *            in.
    */
   public Shape drawMapleLeaf (int x, int y, int width, int height) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
    ...
    *            in.
    */
   public Shape  drawMapleLeaf (int x, int y, int width, int height, int degrees) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
      ...
      //canvas.drawPolygon (xPoints, yPoints, 26, degrees, xc, yc);
    ...
    *            inscribed in.
    */
   public Shape fillMapleLeaf (int x, int y, int width, int height) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
    ...
    *            inscribed in.
    */
   public Shape fillMapleLeaf (int x, int y, int width, int height, int degrees) {
      int[] xPoints, yPoints;
      float rx, ry, xc, yc;
   ...
   public int getMouseMovedX(){
      return canvas.getMouseMovedX();
   }
   public int getMouseMovedY(){
      return canvas.getMouseMovedY();
   }
   public int getMouseButtonPressedX(){
      return canvas.getMouseButtonPressedX();
   }
   public int getMouseButtonPressedY(){
      return canvas.getMouseButtonPressedY();
   }

   public int getMouseButtonReleasedX(){
      return canvas.getMouseButtonReleasedX();
   }
   public int getMouseButtonReleasedY(){
      return canvas.getMouseButtonReleasedY();
   }
   
   
   public int getMouseDraggedX(){
      return canvas.getMouseDraggedX();
   }
   public int getMouseDraggedY(){
      return canvas.getMouseDraggedY();
   }
   
   public MouseEvent getLastMouseEvent(){
      return canvas.getLastMouseEvent();
   }
   ...
   public int[] getKeysDown(){
      ...
      return canvas.getKeysDown();
   }
   
   public int  getButtonDown(){
      return canvas.getButtonDown();
   }
   ...
   public void setTimerDelay(int interval){
